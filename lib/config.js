...
export const namespace = 'token-query-coordinator';
...
cfg.servedQueries = {
  ...
  queryTypes: {
    documentType: '<document type that must match>',
    // define what to return on a matching query
    returnFilter: {
      // returns {<fieldName>: <fieldValue>, ...}; can be empty
